...
class AdsorbateGenerator:
    def __init__(self):
        ...
        self.offsets_A = {
            ...
            "OH":  [("O", -0.60,  0.00, 1.80), ("H", -1.30,  0.60, 2.00)],
            # "OH2":  [("O", -0.60,  0.00, 1.80), ("H", -1.30, -0.60, 2.00)],
            "O":    [("O", -0.80,  0.00, 1.60)],
            "OOH":  [("O", -1.03, -0.82, 1.25), ("O", -1.31, -0.09, 2.38), ("H", -2.15,  0.40, 2.08)],
        ...
        self.offsets_B = {
            ...
            # "OH2":  [("O",  0.60,  0.00, 1.80), ("H",  1.30, -0.60, 2.00)],
            "O":    [("O",  0.80,  0.00, 1.60)],
            "OOH":  [("O",  1.03, -0.84, 1.24), ("O",  1.34, -0.14, 2.37), ("H",  2.17,  0.37, 2.07)],
    ...
    def build_adsorbates_zip(self, selected_sites, reaction_package="OER", custom_variants=None):
        ...
        if reaction_package == "OER":
            variants = {"1-h2o": ["H2O"], "2-oh": ["OH"], "3-o": ["O"], "4-ooh": ["OOH"]}
